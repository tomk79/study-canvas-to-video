...
return call_user_func( function(){
	...
	$conf->funcs->before_content = array(
		...
		\tomk79\pickles2\publishEx\publish::register( array(
			// 'publish_vendor_dir' => true,
			'paths_ignore' => array(
				'/common/px_resources/p/__console_resources/*',
			),
		) ),
	...
	$conf->plugins->px2dt->path_contents_templates_dir = "../px-files/cont_tpls/";
